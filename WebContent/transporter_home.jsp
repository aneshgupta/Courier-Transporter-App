...
<%
	...
	List<Booking> blist =  bdao.requestedBooking(Transporter.getType());
%>
...
<div id="topContainer">
  ...
  <table align="center" border="1" width="50%" style="color: yellow; font-size: 15px; "  >
 	<% 
 		for(Booking b : blist){	
 	%>	
 	<thead style="color: aqua; font-size: 15px;">
 		<tr>
 			<td>Item</td>
 			<td>Approx Weight</td>
 	...
 	<tr>
 		...
 		<td><a href="transporter_booking_accept_form.jsp?bookingId=<%=b.getBookingId()%>">Accept</a></td>
 	</tr>	
 	<%
 		} 	
 	%>
