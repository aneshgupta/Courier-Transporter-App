...
<%@page import="com.goodstransporter.dto.Transporter"%>
...
<div id="topContainer">
  ...
  <br> 		
  <table align="center"  style="color: aqua; font-size: 15px; "  >
  	<form action="transporter_booking_accept.jsp" method="post">
 	<tr>
 		<td><input type="hidden"  name="transporterId" value=" <%=Transporter.getTransporterId()%>"/></td>
 	</tr>
 	<tr>
 		<td><input type="hidden"  name="bookingId" value=" <%=request.getParameter("bookingId")%> "/></td>
 	</tr>
 	<tr>
 		<td>Amount:<br><input type="text"  name="amount" placeholder="Enter amount" /></td>
 	</tr>
 	<tr>
